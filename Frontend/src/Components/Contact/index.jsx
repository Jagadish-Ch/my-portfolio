...
import { getContactDetails } from "../../api/contact.api";
...
const Contact = () => {
  ...
  useEffect(() => {
    getContactDetails()
      .then((res) => {
        // console.log("Contact details fetched successfully: ", res?.data?.[0]);
        setContactConfig(res?.data?.[0]);
      })
      .catch((err) => {
      ...
      <section className="contact active">
        <div className="contact-container">
          <div className="contact-box">
            ...
            <p className="desc">
              <i>
                "Ready to build something great together? Reach out and let’s
                make it happen"
              </i>
            </p>
